...
Node* createTree() {
    ...
    root->left->left->left = nullptr;  // this node is a leaf node
    ...
    root->right->left->left = nullptr;  // this node is a leaf node
    root->right->left->right = new Node(18);

    // level 3 (children of 99)
    root->right->right->left = nullptr;  // this node is a leaf node
    root->right->right->right = nullptr; // this node is a leaf node

    // level 4 (children of 18)
    root->right->left->right->left = nullptr;  // leaf node
